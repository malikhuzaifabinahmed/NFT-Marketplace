        ...
        <div className={Style.footer}>
            <div className={Style.footer_box}>
                <div className={Style.footer_box_social}>
                    ...
                    />
                    <p>
                        This marketplace is a joint effort of Bilal Qamar and
                        Huzaifa bin Ahmed. Every NFT you find here will be one
                        of its kind. Do check out our social handles on the
                        links below.
                    </p>
